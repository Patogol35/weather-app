...
</div>  <p className="subtitle" style={{ padding: "0 1rem" }}>        
  Desarrollado por Jorge Patricio Santamaría Cherrez        
</p>      {/* Buscador */}  <div className="search" style={{ display: "flex", gap: "8px", padding: "0 1rem" }}>        
  <input        
    type="text"        
...
<WeatherCard weather={weather} />  </motion.div>
)}
